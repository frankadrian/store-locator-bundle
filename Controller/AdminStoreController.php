...
use Frank\StoreLocatorBundle\Entity\Store;
use Frank\StoreLocatorBundle\Form\StoreType;

/**
 * AdminStore controller.
 *
 * @Route("/admin/store")
 */
class AdminStoreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FrankStoreLocatorBundle:Store')->findAll();
     ...
     * @Method("POST")
     * @Template("FrankStoreLocatorBundle:Store:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FrankStoreLocatorBundle:Store')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FrankStoreLocatorBundle:Store:edit.html.twig")
     */
